...
if __name__ == "__main__":
    ...
    lower_limit = 0
    fixed_stations = [377,515]#324,3354,509]#[[402,433,515],[351,428,523],[3161,351,406],[2006,496,509],[257,3463,379]]#[238,388]#[238, 388, 482] #[514,482,284]#[253,453,377] #only use these fixed stations
    ...
    trainer_QLN = trainer(station_history, forecasting, remove_only, num_stations, num_sessions, action_space, fixed_stations, use_expected_balances_only, num_clusters, active_cluster, forecast_hours, stock_mode, IDs, assign_mode, upper_limit, lower_limit, use_expected)
    # Execute training
